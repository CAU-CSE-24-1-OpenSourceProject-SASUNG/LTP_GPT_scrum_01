...
gameService.create_game(1, 1, 'Umbrella', 1, 1, 1, True)
gameService.create_game(1, 2, 'Elevator', 1, 1, 1, True)
gameService.create_game(2, 3, 'Umbrella', 1, 1, 1, True)
gameService.create_game(2, 4, 'Elevator', 1, 1, 1, True)
gameService.create_game(3, 5, 'Umbrella', 1, 1, 1, True)
gameService.create_game(3, 6, 'Elevator', 1, 1, 1, True)
gameService.create_game(4, 7, 'Umbrella', 1, 1, 1, True)
gameService.create_game(4, 8, 'Elevator', 1, 1, 1, True)
...
queryService.create_query(1, 1, 'a', 'a', True)
queryService.create_query(2, 2, 'b', 'b', True)
queryService.create_query(3, 3, 'c', 'c', False)
